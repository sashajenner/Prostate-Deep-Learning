...
# Loading the model
json_file = open("../../../data/models/model_010/model_010_init.json", "r")
...
model.load_weights("../../../data/models/model_010/model_010_init.h5")
...
print("Saving the model 010...")

# Serialise model to JSON
model_json = model.to_json()
with open("../../../data/models/model_010/model_010_trained.json", "w") as json_file:
    json_file.write(model_json)

# Serialise weights to HDF5
model.save_weights("../../../data/models/model_010/model_010_trained.h5")
...
metrics.ROC(y_pred, y_test, 10)
metrics.plot_training(history, epoch_num, 10)
