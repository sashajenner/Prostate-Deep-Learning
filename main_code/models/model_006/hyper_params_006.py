...
model.add(keras.layers.Conv2D(32, kernel_size = (3,3), 
                              activation='sigmoid', input_shape = (img_rows, img_cols, channels)))
...
print("Saving model 006 to disk...")

# Serialise model to JSON
model_json = model.to_json()
with open("../../../data/models/model_006/model_006_init.json", "w") as json_file:
    json_file.write(model_json)

# Serialise weights to HDF5
model.save_weights("../../../data/models/model_006/model_006_init.h5")


# Writing the model summary to a file
import sys
sys.stdout = open("../../../data/models/model_006/model_006_summary.txt", "w")
model.summary()
