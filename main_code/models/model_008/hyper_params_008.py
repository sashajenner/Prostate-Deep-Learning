...
# Image dimensions
num_images, img_rows, img_cols, channels = X.shape # (3586, 147, 147, 1)
...
model.add(keras.layers.Conv2D(32, kernel_size = (3,3), 
                              activation='tanh', input_shape = (img_rows, img_cols, channels)))
...
print("Saving model 008 to disk...")

# Serialise model to JSON
model_json = model.to_json()
with open("../../../data/models/model_008/model_008_init.json", "w") as json_file:
    json_file.write(model_json)

# Serialise weights to HDF5
model.save_weights("../../../data/models/model_008/model_008_init.h5")


# Writing the model summary to a file
import sys
sys.stdout = open("../../../data/models/model_008/model_008_summary.txt", "w")
model.summary()
