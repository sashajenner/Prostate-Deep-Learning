...
# Loading the model
json_file = open("../../../data/models/model_003/model_003_init.json", "r")
...
model.load_weights("../../../data/models/model_003/model_003_init.h5")
...
with open("../../../data/models/model_003/model_003_trained.json", "w") as json_file:
    json_file.write(model_json)

# Serialise weights to HDF5
model.save_weights("../../../data/models/model_003/model_003_trained.h5")
...
metrics.ROC(y_pred, y_test, 3)
metrics.plot_training(history, epoch_num, 3)
