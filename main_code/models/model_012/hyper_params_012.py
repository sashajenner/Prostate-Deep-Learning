...
model.add(keras.layers.Conv2D(512, (3,3), activation = 'tanh'))
# The second pooling layer
model.add(keras.layers.MaxPooling2D(pool_size = (3,3)))
...
print("Saving model 012 to disk...")

# Serialise model to JSON
model_json = model.to_json()
with open("../../../data/models/model_012/model_012_init.json", "w") as json_file:
    json_file.write(model_json)

# Serialise weights to HDF5
model.save_weights("../../../data/models/model_012/model_012_init.h5")


# Writing the model summary to a file
import sys
sys.stdout = open("../../../data/models/model_012/model_012_summary.txt", "w")
model.summary()
