...
# Image dimensions
num_images, img_rows, img_cols, channels = X.shape # (3586, 143, 143, 3)
...
with open("../../../data/models/model_001/model_001_init.json", "w") as json_file:
    json_file.write(model_json)

# Serialise weights to HDF5
model.save_weights("../../../data/models/model_001/model_001_init.h5")


# Writing the model summary to a file
import sys
sys.stdout = open("../../../data/models/model_001/model_001_summary.txt", "w")
model.summary()
