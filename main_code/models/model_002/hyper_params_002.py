...
print("Saving model 002 to disk...")

# Serialise model to JSON
model_json = model.to_json()
with open("../../../data/models/model_002/model_002_init.json", "w") as json_file:
    json_file.write(model_json)

# Serialise weights to HDF5
model.save_weights("../../../data/models/model_002/model_002_init.h5")


# Writing the model summary to a file
import sys
sys.stdout = open("../../../data/models/model_002/model_002_summary.txt", "w")
model.summary()
